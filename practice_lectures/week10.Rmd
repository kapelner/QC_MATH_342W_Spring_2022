...
This was a fail. RF is sensitive to the number of features tried. Let's try again.


```{r}
mod_rf = YARF(X, y, num_trees = num_trees, seed = seed, bootstrap_indices = mod_bag$bootstrap_indices, mtry = )
mod_rf
